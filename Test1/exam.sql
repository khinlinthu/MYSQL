...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2020 at 10:40 AM
...
CREATE TABLE `bonus` (
  `id` int(11) NOT NULL,
  `bonusamount` varchar(191) COLLATE utf32_unicode_ci NOT NULL,
...
CREATE TABLE `staffs` (
  `id` int(11) NOT NULL,
  `idno` varchar(191) COLLATE utf32_unicode_ci NOT NULL,
  `name` varchar(191) COLLATE utf32_unicode_ci NOT NULL,
  `fathername` varchar(191) COLLATE utf32_unicode_ci NOT NULL,
...
(2, '123456AB2', 'Aye Aye', 'U Zaw Than Thnin', 200000, '2014-06-11', 6),
(3, '123456AB3', 'Myat Sandar Hlaing', 'U Soe Linn', 300000, '2014-02-20', 3),
(4, '123456AB4', 'Daw Htwe Nyo', 'U Nyut Win', 500000, '2014-06-11', 2),
(5, '123456AB5', 'Kay Thwe', 'U Wana Htun', 450000, '2014-06-11', 4),
